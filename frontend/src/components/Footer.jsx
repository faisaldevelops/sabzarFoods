			...
			<div className='container mx-auto px-4 py-8'>
				<div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
					...
					<div>
						...
						<ul className='space-y-2'>
							<li>
								<a href='https://wa.me/917051896324' target='_blank' rel='noopener noreferrer' className='text-sm text-stone-600 hover:text-stone-900 transition-colors inline-flex items-center gap-2'>
